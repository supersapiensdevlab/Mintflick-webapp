      ...
      <div className='w-full h-full overflow-y-scroll scrollbar-none'>
        <div className='flex flex-col items-start w-full'>
          ...
          <div className='flex items-center gap-1 mx-4'>
            <div className='flex gap-1 items-center cursor-pointer  py-1 px-2 text-xs font-semibold rounded-full border-[1px] border-vapormintBlack-200 text-vapormintSuccess-500  '>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 24 24'
                fill='currentColor'
