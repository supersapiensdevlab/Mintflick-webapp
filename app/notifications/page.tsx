...
export default function page({}: Props) {
  return (
    <FullscreenContainer className='overflow-y-auto scrollbar-none select-none    snap-start border-x-[1px] border-vapormintBlack-200/30 relative flex flex-col items-start max-w-lg py-16 lg:py-2 mx-auto overflow-hidden bg-vapormintBlack-300'>
