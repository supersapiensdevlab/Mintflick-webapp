      ...
      <div className="w-full h-full overflow-y-scroll snap-y scrollbar-none">
        <div className="flex flex-col items-start w-full">
          ...
          <div className="flex items-end w-full gap-3 px-4 py-3 -mt-12">
            ...
            <div className="flex items-center gap-1 p-1 ml-auto text-sm font-semibold cursor-pointer text-vapormintError-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
        ...
        <div className="flex items-center gap-3 px-4 py-3 cursor-pointer bg-vapormintLuxury-300">
          {userState.userData.cover_image ? (
            <Image
