...
function ChatModal(props) {
  ...
  return (
    <div className={`${props.open && "modal-open"} modal  modal-bottom z-50`}>
      <div className=" flex flex-col modal-box  p-0 bg-slate-100 dark:bg-slate-800 ">
