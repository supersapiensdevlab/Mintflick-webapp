...
function MobileHeader() {
  ...
  return (
    <div
      ...
      } transition ease-in-out lg:hidden fixed z-50  top-0 flex px-4 lg:px-12 justify-between items-center h-16 bg-white dark:bg-slate-900 w-full shadow-mintflick`}
    >
