...
function Web3StatusInner() {
  ...
  //         <Web3StatusConnect id="connect-wallet" onClick={addMaticToMetamask} faded={!account}>
  ...
  //     <Web3StatusConnect
  //       id="connect-wallet"
  //       onClick={ethereum && ethereum.isMetaMask ? undefined : toggleWalletModal}
  //       faded={!account}
  //     >
  //       <Text>{ethereum && ethereum.isMetaMask && t('Connect to a wallet')}</Text>
  //     </Web3StatusConnect>
  //   )
  // }
