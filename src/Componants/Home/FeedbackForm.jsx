...
const FeedbackForm = () => {
  ...
  const handleShowWelcome = () => {setShowWelcome(false); setShowFeedback(false)};
  ...
  return (
    <div className="flex flex-col items-center  w-full h-fit bg-slate-100 dark:bg-slate-800 rounded-xl p-5 space-y-2 mt-5">
      {!showFeedback ? (
        <div>
          ...
          <button
            ...
            className="btn mx-auto mt-2  btn-brand "
          >
              Leave your feedback
          </button>
          </div>
        ...
        <div className="grid gap-4 grid-cols-2 ">
          <div className="justify-between flex col-span-2">
            ...
            <a
              ...
              className="opacity-40 text-slate-200"
            >
              close
            </a>
          </div>
