        ...
        if (tokenId && mintingProgress == 66) {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    axios
                        .get(`${process.env.REACT_APP_SERVER_URL}/user.database.userData.data.user/getLoggedInUser`, {
                            headers: {
                                "content-type": "application/json",
        ...
        if (selectedLinkFile) {
            ...
            storeThumbnail(selectedLinkFile.file)
                .then(async (cid) => {
                    ...
                    console.log('https://ipfs.io/ipfs/' + cid + '/' + selectedLinkFile.file[0].name);
                    const data = {
                        image: 'https://ipfs.io/ipfs/' + cid + '/' + selectedLinkFile.file[0].name,
                        url: streamLink.url,
                    };
