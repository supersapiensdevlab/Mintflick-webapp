...
function ConnectWallet() {
  ...
  return (
    <div className="flex  bg-slate-100 dark:bg-slate-900 w-screen h-screen overflow-y-auto">
      <div className="flex flex-col justify-start w-full lg:w-1/2 space-y-6 p-12">
        ...
        <p className="text-brand4 text-lg font-medium">
          Connect your crypto wallet to mint your NFT's in Mintflick.If you do
          not have a wallet then just create one.
        </p>
        ...
        <div className="w-fit border p-4 space-y-2 rounded-lg border-slate-800">
