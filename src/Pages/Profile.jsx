...
function Profile() {
  ...
  return !loader ? (
    <>
      ...
      <div className=" lg:flex lg:flex-row h-screen bg-slate-100 dark:bg-slate-800 lg:bg-white lg:dark:bg-slate-900 overflow-y-auto">
        <div className="flex flex-col h-fit lg:h-full w-full lg:w-1/4 lg:ml-12 lg:mr-4 pt-16 lg:pt-24 space-y-6 lg:overflow-y-auto">
    ...
    <>
      ...
      <button className="btn btn-square btn-ghost loading">loading</button>
    </>
  );
}
