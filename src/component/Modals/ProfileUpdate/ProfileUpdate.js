      ...
      >
        <div className={`${darkMode && 'dark'} p-2 h-max`}>
          ...
          <div className=" bg-white text-gray-500  dark:bg-dbeats-dark-alt dark:text-gray-100   shadow-sm rounded-lg  2xl:px-5 2xl:py-5  lg:px-2 lg:py-1 px-2 py-1 mb-5 lg:mb-2 2xl:mb-5 lg:max-h-full  max-h-96  overflow-y-auto overflow-hidden">
            <div className="md:grid md:grid-cols-2 md:gap-6  ">
              <div className="col-span-1 sm:col-span-1 cursor-not-allowed">
                ...
                <div className="mt-1 flex cursor-not-allowed  shadow-sm  nm-flat-dbeats-dark-secondary-sm p-0.5">
                  <input
                    type="text"
                    name="username"
                    id="username"
              ...
              <div className="col-span-1 sm:col-span-1">
                ...
                <div className="mt-1 flex  shadow-sm  nm-flat-dbeats-dark-secondary-sm p-0.5">
                  <input
                    type="text"
                    name="name"
                    id="name"
          ...
          sm:px-6 flex justify-end items-center "
            >
              <div className="nm-flat-dbeats-dark-secondary-sm  p-1 rounded-3xl hover:nm-inset-dbeats-dark-primary group cursor-pointer">
                <input
                  type="button"
