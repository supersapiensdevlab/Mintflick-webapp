...
function TextareaInput(props: Props) {
  return (
    <div className="flex flex-col items-start justify-start w-full gap-1 py-1">
      ...
      <textarea
        className="w-full h-20 text-base text-white bg-black border-b rounded-none hover:resize-y scrollbar scrollbar-thumb-gray-900 scrollbar-track-black border-slate-700 focus:border-white focus:outline-none"
